...
calc_route_pb = Blueprint("calc_routes", __name__)

@calc_route_pb.route('/calculator/1', methods=["POST"])
def calculator_1():
    try:
...
@calc_route_pb.route('/calculator/2', methods=["POST"])
def calculator_2():
    try:
...
@calc_route_pb.route('/calculator/3', methods=["POST"])
def calculator_3():
    try:
